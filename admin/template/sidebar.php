        ...
        <div class="navbar-default sidebar nicescroll" role="navigation">
            <div class="sidebar-nav navbar-collapse ">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="basic-table.php" class="waves-effect"><i class="ti-layout fa-fw"></i>Basic-Table</a>
                    </li>
                    <li>
                        <a href="themifyicon.php" class="waves-effect"><i class="ti-face-smile fa-fw"></i> Icons</a>
                    </li>
                    <li>
                        <a href="map-google.php" class="waves-effect"><i class="ti-location-pin fa-fw"></i> Google Map</a>
                    </li>
                    <li>
                        <a href="blank.php" class="waves-effect"><i class="ti-files fa-fw"></i> Blank Page</a>
                    </li>
                    <li>
                        <a href="404.php" class="waves-effect"><i class="ti-info fa-fw"></i> Error 404</a>
                    </li>
                </ul>
                <!-- <div class="center p-20">
                    <span class="hide-menu"><a href="#" target="_blank" class="btn btn-info btn-block btn-rounded waves-effect waves-light">Upgrade to Pro</a></span>
                </div> -->
            </div>
            <!-- /.sidebar-collapse -->
        </div>
