                        ...
                        <div class="col-lg-8">
                            <div class="header-topbar-layout1">
                                <div class="header-top-left">
                                    <ul>
                                        <li><i class="fas fa-map-marker-alt"></i><span>Address:</span> Majri Mafi Mohkampur, Near Two Tower </li>
                                        <li><i class="far fa-clock"></i><span>Opening Hours:</span> Mon-Fri: 09.00am - 07.00 pm</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="header-top-right">
                                    <ul>
                                        ...
                                        <li class="social-icon">
                                            <a href="#"><i class="fab fa-whats's-app"></i></a>
                                   ...
                                   <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-col-1">
                                            ...
                                            <li>
                                                <a href="single-service.php">Service Details</a>
                                            </li>
                                    ...
                                    <li class="position-static hide-on-mobile-menu">
                                        ...
                                        <div class="template-mega-menu">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="menu-ctg-title">Shopping</div>
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="shop.html">
